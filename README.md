...
**Realistic e-commerce/admin demo:** if you want to see Scrypath in action before wiring your own app, run [examples/scrypath_ecommerce](examples/scrypath_ecommerce/README.md). It mounts the optional operator UI beside a multi-tenant catalog storefront so you can click through tenant-scoped search, category facets, related-data propagation, failed sync triage, and swap posture.
