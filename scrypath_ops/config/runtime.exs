...
#
#     PHX_SERVER=true bin/scrypath_ops start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :scrypath_ops, ScrypathOpsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :scrypath_ops, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :scrypath_ops, ScrypathOps.Mailer,
