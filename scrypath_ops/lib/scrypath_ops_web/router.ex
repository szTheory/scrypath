  ...
  defmacro scrypath_ops_routes(path, opts \\ []) do
    quote bind_quoted: [path: path, opts: opts] do
      ...
      scope path, alias: false, as: false do
        ...
        forward "/assets", ScrypathOpsWeb.AssetPlug
        forward "/images", ScrypathOpsWeb.AssetPlug

        live_session :ops, on_mount: [{ScrypathOpsWeb.Live.OnMount, :default}], session: %{"scrypath_ops_opts" => validated_opts} do
