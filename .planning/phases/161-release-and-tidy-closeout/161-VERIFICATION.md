...
covered_digest: "v1:sha256:6f6bab2cf1b69cf5616b0d35bbed52e40bc2cf204488298a7522e23c9e790b1b"
...
| 3 | PRs are triaged, exact-final-SHA checks pass, and publication or explicit release-ready blocker is recorded. | ✓ VERIFIED | PR #77 disposition and review/merge blocker are explicit. Run 36059427918 passes on current HEAD; publication remains release-ready/unpublished with an exact resume action. |
...
| 12 | Candidate commit has five required checks and SHA-bound closeout artifacts. | ✓ VERIFIED | Receipt and GitHub run 36059427918 both identify SHA `c5e97610821d375a0e50deb0f5abb4db93832178`, the current local HEAD and remote branch head. All five required jobs, coverage, and closeout attestation succeeded. Coverage artifact 10833846869 digest `sha256:2a8bb8c656dc8486901d8a0fa9236745002600961ad329502c9c64dc7336c5b4`; attestation artifact 10833502878 digest `sha256:a1b67a90b88638b63e363ade1fb84f3a63cdfad6aa204d7e17689d062a8f549c`. |
...
| 16 | Final committed artifacts have fresh exact-SHA closeout; later tracked edits trigger another run. | ✓ VERIFIED | Latest workflow_dispatch run and immutable artifacts are tied to current HEAD/remote SHA `c5e97610821d375a0e50deb0f5abb4db93832178`. No later implementation or planning edits followed the attested HEAD; this verification refresh itself remains uncommitted. |
...
| `161-VALIDATION.md` | Candidate/final SHA and receipts | ✓ VERIFIED | Final closeout run 36059427918 and its receipt match current HEAD. |
...
| Candidate SHA | GitHub CI | Exact SHA/jobs/artifacts | WIRED | Run 36059427918 and its artifacts match local and remote SHA c5e97610821d375a0e50deb0f5abb4db93832178. |
...
| Release evidence | SHA/run/artifact fields | GitHub | Yes for current HEAD c5e97610821d375a0e50deb0f5abb4db93832178 | FLOWING |

## Behavioral Spot-Checks

| Behavior | Command | Result | Status |
|---|---|---|---|
| Current HEAD has final closeout evidence | `gh run view 36059427918 --json headSha,event,status,conclusion,jobs` plus receipt and `git ls-remote origin refs/heads/gsd/v1.37-code-quality-ratchet` | Run, receipt, local HEAD, and remote branch all match c5e97610821d375a0e50deb0f5abb4db93832178; all five required jobs, coverage, and attestation pass | ✓ PASS |
| Receipt artifact identities match GitHub | `gh api repos/szTheory/scrypath/actions/runs/36059427918/artifacts` | Coverage artifact 10833846869 and attestation artifact 10833502878 are unexpired and digests match receipt | ✓ PASS |
...
The prior exact-SHA gap is closed. Receipt `/private/tmp/scrypath-161-final-closeout.json`, GitHub run 36059427918, local HEAD, and the remote branch all identify `c5e97610821d375a0e50deb0f5abb4db93832178`. GitHub confirms the five required jobs, coverage, and closeout attestation succeeded; artifact IDs and digests match the receipt and remain unexpired. No later implementation or planning edits followed the attested HEAD; this verification refresh remains uncommitted. Phase 161 is release-ready and not shipped: PR #77 still needs actual maintainer review and merge, followed by the Release Please/Hex/HexDocs/parity path.

---

_Verified: 2026-09-24T21:19:46Z_  
