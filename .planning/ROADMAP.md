...
**Last shipped milestone:** **v1.22 Composition And Real-App Depth** — shipped + archived **2026-05-24**, **3** phases (**83–85**) complete, **12** requirements (**CMP-01**..**VRFY-01**) satisfied. See **`milestones/v1.22-{ROADMAP,REQUIREMENTS,MILESTONE-AUDIT}.md`**.

**Next default pull:** milestone complete; do not open another internal phase by default unless real adopter evidence or a leverage-positive release/distribution need changes the guardrail.
...
---
*Last updated: 2026-05-24 — archived `v1.22` and returned the roadmap to a between-milestones state*
