...
- [x] **v1.27 shipped + archived in-repo** (**2026-05-30**) — *Adopter Contract Hardening* — phases **97–101** — [archive](milestones/v1.27-ROADMAP.md)
...
None active. See `PROJECT.md` for next goals or start a new milestone with `/gsd:new-milestone`.
