...
**Plans:** 7 plans
- [ ] 18-01-PLAN.md — Wave 0 test scaffolding + mix.exs cli.preferred_envs (covers INFRA-01..04 via Wave-0 anchors)
- [ ] 18-02-PLAN.md — verify.workspace_clean Mix task (INFRA-01)
- [ ] 18-03-PLAN.md — verify.release_parity Mix task (INFRA-02)
- [ ] 18-04-PLAN.md — ci.yml Node 20 pin swaps (INFRA-03, 8 @v4 → @v6/@v5)
- [ ] 18-05-PLAN.md — workspace_clean wired into ci.yml + release-please.yml + publish-hex.yml (INFRA-01 cross-workflow)
- [ ] 18-06-PLAN.md — verify-published-release.yml release_parity step + drift-issue wiring + issue template (INFRA-02 cron + INFRA-04)
...
|-------|----------------|--------|-----------|
| 18. Release-Parity Gate + Node 20 CI Cleanup | 0/? | Not started | - |
