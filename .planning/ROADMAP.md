...
- [x] 160-01-PLAN.md — Add the package-backed Phoenix proof command and cleanup contracts
...
- [x] 160-03-PLAN.md — Obtain and record the package-backed Phoenix proof on the candidate SHA
