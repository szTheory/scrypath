# Milestone archive: v1.6 — Adoption-grade integration and trust

**Archived:** 2026-04-19  
**Hex:** `scrypath` **0.3.3** (no new Hex line in this milestone; planning-track adoption, proof, and verification clarity)  
**Phases:** 29–35 (**7** phases, **7** numbered `*-PLAN.md` executions; phases **30–31** were verification-led without separate plan directories)  
**Audit:** [v1.6-MILESTONE-AUDIT.md](v1.6-MILESTONE-AUDIT.md) (status `tech_debt` at close — requirements satisfied; residual items documented there)  
**Canonical snapshot:** Captured from `.planning/ROADMAP.md` at milestone close (link to audit file updated for archive-relative path).
...
- [x] `v1.0` shipped on 2026-04-16 — 7 phases, 25 plans — [archive](v1.0-ROADMAP.md)
- [x] `v1.1` shipped on 2026-04-16 — 3 phases, 9 plans — [archive](v1.1-ROADMAP.md)
- [x] `v1.2` shipped on 2026-04-17 — 7 phases, 13 plans — [archive](v1.2-ROADMAP.md)
- [x] `v1.3` shipped on 2026-04-17 — 6 phases (18–23), 18 plans — [archive](v1.3-ROADMAP.md) · [requirements](v1.3-REQUIREMENTS.md)
- [x] **`v1.4` shipped on 2026-04-17** — 3 phases (24–26), 8 plans — [archive](v1.4-ROADMAP.md) · [requirements](v1.4-REQUIREMENTS.md)
- [x] **`v1.5` shipped in-repo** (2026-04-18) — 2 phases (27–28), 5 plans — [archive](v1.5-ROADMAP.md) · [requirements](v1.5-REQUIREMENTS.md) — *Operator drift and schema-diff tooling*
- [ ] **`v1.6` in progress** — **7** phases (29–35): **29–35** complete in-repo (phase **35** sync-guide lifecycle parity 2026-04-19); **milestone audit** / close next — [requirements](v1.6-REQUIREMENTS.md) — *Adoption-grade integration and trust*

## Next milestone

**v1.6 — Adoption-grade integration and trust** — phases **29–35** · [REQUIREMENTS.md](v1.6-REQUIREMENTS.md)
...
**Gap closure (33–35):** Addresses **[`v1.6-MILESTONE-AUDIT.md`](v1.6-MILESTONE-AUDIT.md)** `gaps.integration` / `gaps.flows`. Optional later: Nyquist **`VALIDATION.md`** for phases **30–31** and plan **`SUMMARY`** backfill — **deferred** until after these doc fixes unless policy hard-requires the three-source matrix.
...
Full detail: [v1.5-ROADMAP.md](v1.5-ROADMAP.md).
...
Full detail: [v1.4-ROADMAP.md](v1.4-ROADMAP.md).
...
Details: [v1.3-ROADMAP.md](v1.3-ROADMAP.md).

</details>

## Progress

**Active milestone:** **v1.6** — **Phases 29–35** verified in-repo (phase **35**: README ↔ **`guides/sync-modes-and-visibility.md`** operator lifecycle parity, 2026-04-19). Next: **`/gsd-audit-milestone v1.6`**, then **`/gsd-complete-milestone v1.6`** when ready. Shipped **v1.5** tables: **`v1.5-ROADMAP.md`** (this archive directory).
