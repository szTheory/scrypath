# Milestone archive: v1.4 — Requirements

**Archived:** 2026-04-17  
**Milestone:** v1.4 "Public package parity & operator depth"  
**Canonical snapshot:** Copied from `.planning/REQUIREMENTS.md` at milestone close (all traceability rows **Complete**).
...
- [x] **SHIP-01**: Semver **0.3.1** was cut through the documented Release Please path; published tarball matches the Release Please release ref (git tag **`scrypath-v0.3.1`** on GitHub; Actions publish job, 2026-04-17).
