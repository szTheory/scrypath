...
`phase105-e2e` should remain advisory in Phase 111 and be hardened as an evidence lane, not promoted as a required gate yet. [VERIFIED: `.planning/milestones/v1.30-phases/111-advisory-proof-stability-decision/111-CONTEXT.md`] [VERIFIED: `CONTRIBUTING.md`]
...
- [CITED: `.planning/milestones/v1.30-phases/111-advisory-proof-stability-decision/111-CONTEXT.md`] - locked decisions, discretion, deferred scope
