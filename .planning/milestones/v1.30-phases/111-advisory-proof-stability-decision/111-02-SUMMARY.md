...
- Added `.planning/milestones/v1.30-phases/111-advisory-proof-stability-decision/111-DECISION.md` as the Phase 111 decision authority with frozen remote-run sample references, dual-window model, threshold tokens, and explicit non-goals.
...
- `.planning/milestones/v1.30-phases/111-advisory-proof-stability-decision/111-DECISION.md` - phase-local policy authority with frozen evidence sample and promotion contract.
