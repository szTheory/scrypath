...
### Prior Decisions
- `.planning/milestones/v1.30-phases/109-release-train-and-package-truth-audit/109-CONTEXT.md` - release-truth decisions, especially lean always-on gates and route-first docs.
- `.planning/milestones/v1.30-phases/110-support-intake-and-evidence-routing/110-CONTEXT.md` - support routing, single-source compatibility authority, and deferral of broad website narrative to Phase 112.
- `.planning/milestones/v1.30-phases/111-advisory-proof-stability-decision/111-CONTEXT.md` - advisory/required proof discipline, lean required gates, and contract-test posture.
- `.planning/milestones/v1.27-phases/97-canonical-contract-freeze-and-scope-guard/97-SCOPE-GUARD.md` - canonical scope guard authority banning unsupported capability classes.
