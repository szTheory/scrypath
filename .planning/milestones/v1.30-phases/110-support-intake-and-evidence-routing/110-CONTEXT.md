...
- `.planning/milestones/v1.30-phases/109-release-train-and-package-truth-audit/109-CONTEXT.md` - prior release-truth decisions, especially lean required gates, route-first docs, and no heavyweight process.
