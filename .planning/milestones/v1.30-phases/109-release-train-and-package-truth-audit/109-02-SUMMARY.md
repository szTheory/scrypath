...
- Reconstructed `.planning/milestones/v1.27-phases/97-canonical-contract-freeze-and-scope-guard/97-CONTRACT-STATEMENTS.md` with required frozen IDs: `CST-TRUTH-01-INSTALL`, `CST-TRUTH-02-RELEASE-MAIN`, `CST-TRUTH-03-SUPPORT-AUTHORITY`.
- Reconstructed `.planning/milestones/v1.27-phases/97-canonical-contract-freeze-and-scope-guard/97-CONTRACT-TRACEABILITY.md` with explicit `TRUTH-01`, `TRUTH-02`, `TRUTH-03` rows.
- Reconstructed `.planning/milestones/v1.27-phases/97-canonical-contract-freeze-and-scope-guard/97-SCOPE-GUARD.md` with `SCOPE-01`, banned capability classes, and reopen policy requiring reviewed outside-adopter signal or reproducible production bug.
