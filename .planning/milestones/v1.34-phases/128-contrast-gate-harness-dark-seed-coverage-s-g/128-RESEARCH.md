...
**D-17:** Both producers emit the same `scrypath.contrast.v1` schema. Paths: `test-results/contrast/contrast-report.{json,md}` (gitignored) + `.planning/milestones/v1.34-phases/128-…/128-CONTRAST-REPORT.md` (committed).
...
| Report output | `examples/scrypath_ecommerce/test-results/contrast/` (gitignored) | `.planning/milestones/v1.34-phases/128-…/128-CONTRAST-REPORT.md` (committed) | Mirrors screenshot matrix evidence discipline (D-17) |
