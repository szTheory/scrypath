...
**Analog search scope:** `scrypath_ops/assets/css/`, `examples/scrypath_ecommerce/`, `scrypath_ops/lib/scrypath_ops_web/components/`, `.planning/milestones/v1.34-phases/130-*`, `.planning/milestones/v1.34-phases/131-*`, `prompts/`
