...
- `.planning/REQUIREMENTS.md` → **DARKTOKEN-01** (the requirement this phase closes) and the
  §Traceability table.
- `.planning/milestones/v1.34-phases/129-dark-theme-brand-expression-audit-s-r/129-DARK-AUDIT-BACKLOG.md` — **the
...
- `.planning/milestones/v1.34-phases/128-contrast-gate-harness-dark-seed-coverage-s-g/128-CONTRAST-REPORT.md` —
