...
key-files:
  created:
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-03-SUMMARY.md
  modified:
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json
    - .planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md
...
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md` - Bounded Human UAT checklist and approved sign-off.
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md` - Final DUALVERIFY-01 status, UAT result, defect/follow-up decision, and generated-artifact hygiene.
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json` - Final manifest with UAT status and committed artifact checksums.
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md` - v1.34 audit promoted from PENDING UAT to PASSED.
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-03-SUMMARY.md` - This plan summary.
...
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md`.
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md`.
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json`.
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-BEFORE-AFTER.md`.
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md`.
- Found `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-03-SUMMARY.md`.
