...
- `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-CONTEXT.md` — Phase 135 boundary and explicit handoff of full gallery/audit/UAT to Phase 136.
- `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-SHELL-CHROME-REPORT.md` — latest shell evidence and report pattern to extend for final closeout.
- `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-04-SUMMARY.md` — Phase 135 final gate results and handoff decisions.
- `.planning/milestones/v1.34-phases/134-under-iterated-surface-polish-dual-theme-s/134-CONTEXT.md` — surface-depth decisions, light parity, system-dark proof, and Phase 136 deferrals.
- `.planning/milestones/v1.34-phases/133-dark-path-motion-expression-r-g/133-CONTEXT.md` — motion boundaries, reduced-motion rules, and Phase 136 gallery/UAT deferral.
- `.planning/milestones/v1.34-phases/132-a11y-contrast-remediation-both-themes-hard-gate-g/132-CONTRAST-REPORT.md` — AA/AAA reporting precedent and Phase 132 contrast baseline.
...
### Integration Points
- Phase 136 reports live under `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/`.
