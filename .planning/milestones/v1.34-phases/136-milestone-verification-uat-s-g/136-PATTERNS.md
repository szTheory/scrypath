...
|-------------------|------|-----------|----------------|---------------|
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md` | report | batch + file-I/O | `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-SHELL-CHROME-REPORT.md` | exact |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json` | manifest/config | batch + transform + file-I/O | `examples/scrypath_ecommerce/e2e/admin_contrast_matrix.spec.ts` + `examples/scrypath_ecommerce/e2e/admin_screenshot_matrix.spec.ts` | partial |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-BEFORE-AFTER.md` | gallery report | file-I/O + transform | `.planning/milestones/v1.33-phases/127-shell-coherence-and-verification/v1.33-BEFORE-AFTER.md` | exact |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md` | audit report | batch + transform | `.planning/milestones/v1.33-MILESTONE-AUDIT.md` | exact |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md` | UAT artifact | human event-driven + file-I/O | `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-UAT.md` + `.planning/milestones/v1.34-phases/133-dark-path-motion-expression-r-g/133-UAT.md` | role-match |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-CONTRAST-REPORT.md` (optional) | a11y report | batch + file-I/O | `.planning/milestones/v1.34-phases/132-a11y-contrast-remediation-both-themes-hard-gate-g/132-CONTRAST-REPORT.md` | exact |

## Pattern Assignments

### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md` (report, batch + file-I/O)

**Analog:** `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-SHELL-CHROME-REPORT.md`
...
**Contrast transcript pattern to embed or link** from `.planning/milestones/v1.34-phases/132-a11y-contrast-remediation-both-themes-hard-gate-g/132-CONTRAST-REPORT.md` (lines 47-108):
...
### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json` (manifest/config, batch + transform + file-I/O)
...
### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-BEFORE-AFTER.md` (gallery report, file-I/O + transform)
...
### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md` (audit report, batch + transform)
...
### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md` (UAT artifact, human event-driven + file-I/O)

**Analogs:** `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-UAT.md`, `.planning/milestones/v1.34-phases/133-dark-path-motion-expression-r-g/133-UAT.md`, `.planning/milestones/v1.16-phases/65-playbook-run-lifecycle-opsui/65-HUMAN-UAT.md`
...
### `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-CONTRAST-REPORT.md` (optional a11y report, batch + file-I/O)

**Analog:** `.planning/milestones/v1.34-phases/132-a11y-contrast-remediation-both-themes-hard-gate-g/132-CONTRAST-REPORT.md`
...
**Read-only boundary:** Product source was not modified. This pattern map writes only `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-PATTERNS.md`.
