...
|---|---|---|---|
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-DUALVERIFY-REPORT.md` | Automated gate report and final UAT status | VERIFIED | Exists, substantive, and records DUALVERIFY-01, source lane, gate results, recapture note, Human UAT, and artifact hygiene. |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-ARTIFACT-MANIFEST.json` | Machine-readable manifest | VERIFIED | Valid JSON with schema `scrypath.phase136.artifacts.v1`, final status, screenshot checksums, committed artifacts, and canonical self-checksum. |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-BEFORE-AFTER.md` | Dark-weighted before/after gallery | VERIFIED | Exists, substantive, claim-based, dark-weighted, and reconciled to current manifest paths/checksums. |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-MILESTONE-AUDIT.md` | Milestone audit | VERIFIED | Covers intent, phases, requirements, gates, artifacts, gallery evidence, scope guard, follow-ups, blockers, and verdict. |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-UAT.md` | Bounded human UAT | VERIFIED | Passed with reviewer response `approved`, no issues, no pending items, no blockers. |
| `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-REVIEW.md` | Execute-post code review | VERIFIED | Clean review: 4 files reviewed, 0 findings. |
