...
```text
.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/
├── 136-RESEARCH.md
├── 136-DUALVERIFY-REPORT.md
├── 136-ARTIFACT-MANIFEST.json
├── 136-BEFORE-AFTER.md
...
**Warning signs:** Commit file list includes source files outside `.planning/milestones/v1.34-phases/136-*` without a documented must-fix defect. [VERIFIED: 136-CONTEXT.md]
...
| DUALVERIFY-01 | Before/after, milestone audit, UAT complete | manual/report | `rg -n "DUALVERIFY-01|PASS|FAIL|follow-up" .planning/milestones/v1.34-phases/136-*/136-*.md` | ❌ Wave 0 creates reports [VERIFIED] |
...
- `.planning/milestones/v1.34-phases/136-milestone-verification-uat-s-g/136-CONTEXT.md` - locked decisions, artifact contract, UAT thresholds. [VERIFIED: codebase grep]
...
- `.planning/milestones/v1.34-phases/132-a11y-contrast-remediation-both-themes-hard-gate-g/132-CONTRAST-REPORT.md`, `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-SHELL-CHROME-REPORT.md`, `.planning/milestones/v1.33-MILESTONE-AUDIT.md`. [VERIFIED: codebase grep]
