...
key_files:
  created:
    ...
    - .planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/deferred-items.md
  modified:
...
- `mix precommit` exposed formatter churn in unrelated files outside Plan 135-02. Details are logged in `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/deferred-items.md`.
