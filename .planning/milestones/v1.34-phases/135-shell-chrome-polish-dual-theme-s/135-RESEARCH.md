...
1. **Should the command palette keep `aria-modal="true"`?**
   ...
   - RESOLVED: `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-01-PLAN.md` Task 1 creates the browser proof branch, `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-03-PLAN.md` Task 1 implements either bounded focus behavior or semantic downgrade, `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-03-PLAN.md` Task 3 runs the focused browser proof, and `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-04-PLAN.md` Task 2 records the final resolution.
...
2. **Should static shell CSS tripwires be added to `mix verify.opsui`?**
   ...
   - RESOLVED: `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-02-PLAN.md` Task 2 adds `shell_chrome_token_contract_test.exs` only for durable shell invariants, `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-03-PLAN.md` Task 2 extends static tripwires for palette/flash dual-dark mirrors, and `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-04-PLAN.md` Task 1 runs `mix verify.opsui` plus the nested app `mix precommit` gate.
...
3. **How much wash tuning is enough?**
   ...
   - RESOLVED: `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-02-PLAN.md` Task 2 bounds `.ops-shell` to one radial wash plus the existing linear floor, `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-02-PLAN.md` Task 3 proves the wash by computed browser checks across themes/viewports/screens, and `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-04-PLAN.md` Task 2 records wash boundedness in the final evidence report.
...
- `.planning/milestones/v1.34-phases/135-shell-chrome-polish-dual-theme-s/135-CONTEXT.md` - locked phase scope, decisions, and verification shape. [VERIFIED: codebase grep]
