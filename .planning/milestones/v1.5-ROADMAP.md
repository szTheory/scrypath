# Milestone archive: v1.5 — Operator drift and schema-diff tooling

**Archived:** 2026-04-18  
**Hex:** `scrypath` **0.3.3** (line on Hex at archive time; this milestone is planning-track / in-repo delivery)  
**Phases:** 27–28 (2 phases, 5 plans)  
**Canonical snapshot:** Copied from `.planning/ROADMAP.md` at milestone close.
