...
- [x] **Phase 57: Evidence triage and B1 scope lock** — **EVID-01** frozen ledger **`.planning/milestones/v1.14-EVID-01-b1.md`**, contributor gates (**PR template**, **CODEOWNERS**), planning mirrors — **EVID-01**.
...
- **Tier C** — heavy browser CI, Meilisearch-in-OPSUI CI — **`.planning/reference/milestone-candidates.md`** until proven need.
