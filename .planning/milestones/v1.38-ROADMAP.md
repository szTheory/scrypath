...
- ✅ **v1.38 Packaged Adopter Proof** — Phases 160–161 (shipped 2026-09-25; Scrypath 0.3.13 published)

## Current Posture

No active milestone. v1.38 shipped as Scrypath 0.3.13; the green-main release train is idle pending concrete work evidence.
...
**Plans**: 4/4 plans executed. PR #77 and Release Please PR #78 passed exact-head checks and were merged with maintainer authorization; Hex 0.3.13, HexDocs, consumer compile, package/tag parity, and post-merge main CI passed.
...
|-------|-----------|----------------|--------|-----------|
| 160. Package-Backed Phoenix Proof | v1.38 | 3/3 | Complete    | 2026-09-25 |
| 161. Release and Tidy Closeout | v1.38 | 4/4 | Complete    | 2026-09-25 |

## Final Release Update (2026-09-25)

Scrypath 0.3.13 shipped after this roadmap snapshot was captured. PR #77 and Release Please PR #78 passed exact-head checks and were squash-merged with maintainer authorization; post-merge main CI, Hex publication, versioned HexDocs, clean-consumer compilation, and package-to-tag parity all passed. See `v1.38-phases/161-release-and-tidy-closeout/161-RELEASE-EVIDENCE.md` and `v1.38-MILESTONE-AUDIT.md`.
