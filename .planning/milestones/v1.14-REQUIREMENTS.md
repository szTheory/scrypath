# Requirements archive: Scrypath v1.14 — Library QoL and operator playbooks

**Archived:** 2026-04-22  
**Milestone:** v1.14 — *Library QoL and operator playbooks* (**Tier B1** + **Tier B2** / **OPSUI-FUT-01**)  
**Outcomes:** **EVID-01**, **LIB-01**–**LIB-03**, **OPS-PB-01**–**OPS-PB-05**, **SHIP-01** satisfied per traceability and phases **57–61**; **AUDT-01** retained as historical registry row. Residual audit notes: **`milestones/v1.14-MILESTONE-AUDIT.md`** (**`tech_debt`**).
...
- [x] **EVID-01**: Maintainer publishes a **frozen evidence list** for **B1** (issue URLs, quoted support text, or dated dogfood notes) in-repo before **LIB-*** work merges; items not on the list are out of scope for v1.14 core changes. Canonical ledger: **`.planning/milestones/v1.14-EVID-01-b1.md`**.
  **Evidence:** `.planning/research/SUMMARY.md` (“B1 delivery confidence depends on locking an evidence list”); `.planning/reference/milestone-candidates.md` **B1** (“only when tied to **concrete** adopter or maintainer pain”).
...
- [x] **LIB-02**: For **at least one** library or verify path discovered during v1.14 dogfood, reduce confusion **without** new public macros — prefer clearer typespecs, `@doc`, or a **small** pure helper — and record the before/after confusion in the evidence list (**EVID-01**).  
  **Evidence:** `.planning/reference/milestone-candidates.md` **B1**; `.planning/research/PITFALLS.md` (speculative API churn pitfall).
...
- Playwright-on-all-flows, Meilisearch-in-OPSUI CI, exhaustive visual regression — deferred per **`.planning/reference/milestone-candidates.md`** **Tier C** until a proven failure mode.
...
|-------------|-------|--------|
| EVID-01 (ledger `.planning/milestones/v1.14-EVID-01-b1.md`) | Phase 57 | Complete |
