# Requirements archive: Scrypath v1.7

**Archived:** 2026-04-20  
**Milestone:** v1.7 — *Facet depth and catalog search UX*  
**Outcomes:** All four **FACET-** requirement IDs **satisfied** per phase **`VERIFICATION.md`**, plan summaries, and **`milestones/v1.7-MILESTONE-AUDIT.md`** (audit status `tech_debt`: Nyquist drafts, operator merge wiring, doc mental-model notes — see audit YAML). **AUDT-01** retained in traceability table for continuity from v1.6; not part of v1.7 execution scope.
