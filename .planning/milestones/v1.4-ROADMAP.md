# Milestone archive: v1.4 — Public package parity & operator depth

**Archived:** 2026-04-17  
**Hex:** `scrypath` **0.3.1** (Release Please tag `scrypath-v0.3.1` on GitHub)  
**Phases:** 24–26 (3 phases, 8 plans)  
...
- [x] **`v1.4` shipped on 2026-04-17** — 3 phases (24–26), 8 plans — [requirements](v1.4-REQUIREMENTS.md)
