# Requirements Archive: v1.36 Dependency Security Remediation

**Archived:** 2026-08-25
**Status:** SHIPPED

The next approved milestone creates a fresh `.planning/REQUIREMENTS.md`.
...
- [x] **SEC-02:** Maintainers can resolve the legacy Phoenix example's recorded advisories through coordinated Phoenix/Bandit and Ecto/Ecto SQL/Decimal upgrades.
- [x] **SEC-03:** Maintainers can independently resolve ScrypathOps beyond its recorded web, LiveView, mailer, HTTP, and database advisories.
...
- [x] **EVID-03:** Postgrex changes remain blocked until both the live advisory and Hex registry confirm a stable published fixed release; maintainers do not substitute an invented version or prerelease.
...
*Last updated: 2026-08-25 after milestone audit synchronized verified Phase 146 completion*
