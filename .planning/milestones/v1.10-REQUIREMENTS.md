# Requirements archive: Scrypath v1.10 — Operator admin UI (OPSUI)

**Archived:** 2026-04-21  
**Milestone:** v1.10 — *Operator admin UI (OPSUI)*  
**Outcomes:** **OPSUI-01**..**OPSUI-10** satisfied per phase summaries, **`scrypath_ops`** LiveViews, **`operator-ia.md`**, stubbed **`LiveViewTest`** paths, and maintainer contract tests in CI.
