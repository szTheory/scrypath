# Requirements archive: Scrypath v1.8

**Archived:** 2026-04-20  
**Milestone:** v1.8 — *Multi-index federation*  
**Outcomes:** **FED-01**, **FED-02**, and **FED-03** satisfied per phase summaries, `REQUIREMENTS.md` traceability, and verify slices (**`mix verify.phase41`** and related tests). **OPSUI-01** remains explicitly deferred (see archived roadmap backlog).
