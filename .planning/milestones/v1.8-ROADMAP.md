# Milestone archive: v1.8 — Multi-index federation

**Archived:** 2026-04-20  
**Hex:** `scrypath` **0.3.3** (federation APIs and docs shipped in-repo at archive; no mandated Hex bump in this planning milestone)  
**Phases:** 39–41 (**3** phases, **6** plans)  
**Audit:** No `v1.8-MILESTONE-AUDIT.md` at close (optional **`/gsd-audit-milestone`** deferred). **`audit-open`** items **acknowledged** at close — see **`STATE.md`** § Deferred Items.  
...
- [x] **`v1.8` shipped in-repo** (2026-04-20) — *Multi-index federation* — phases **39–41** — [requirements](v1.8-REQUIREMENTS.md)

## Next milestone

**v1.8 — Multi-index federation** (phases **39–41**) is **complete in-repo** as of **2026-04-20**; see **`v1.8-REQUIREMENTS.md`** (**`FED-01`..`FED-03`** complete). **Operator LiveView dashboard (`OPSUI-01`)** is the natural **follow-up** when you want a UI over federation-shaped results. Older backlog items below remain available if reprioritized.
