...
last_updated: "2026-04-21T02:56:52.134Z"
...
1. **`/gsd-progress`** — optional health read while phase 44 runs
2. **`/gsd-execute-phase 44`** — resume if interrupted (skips plans with SUMMARY)
