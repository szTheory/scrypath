...
- [x] **EVID-01**: Maintainer publishes a **frozen evidence list** for **B1** (issue URLs, quoted support text, or dated dogfood notes) in-repo before **LIB-*** work merges; items not on the list are out of scope for v1.14 core changes. Canonical ledger: **`.planning/EVID-01-b1-v1.14.md`**.  
