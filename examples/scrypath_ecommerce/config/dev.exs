...
config :scrypath_ecommerce, ScrypathEcommerceWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:scrypath_ecommerce, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:scrypath_ecommerce, ~w(--watch)]}
  ]
...
config :scrypath_ecommerce, dev_routes: true
