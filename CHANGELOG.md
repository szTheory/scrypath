...
* **phase105-e2e:** run e2e server on a non-sandbox DB so the active index populates ([#40](https://github.com/szTheory/scrypath/issues/40)) ([c79ae3b](https://github.com/szTheory/scrypath/commit/c79ae3bfc91f487ef4e463517ee8e5a5dee5dd7a))
